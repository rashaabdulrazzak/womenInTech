...
```
near call $CONTRACT addProject '{"name":"Scolarships", "description":"Give a support to provide more scolarship average estimate of one scolarship is 1000 USD"}' --accountId $CONTRACT
```
